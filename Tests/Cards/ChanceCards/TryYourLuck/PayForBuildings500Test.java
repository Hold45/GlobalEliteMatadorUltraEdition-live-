...
public class PayForBuildings500Test extends CardTemplateTest{

	@Override
	public void setup() {
		card = new PayForBuildings500(cardPile);
	}

	/**
	 * @see PayForBuildings500#draw(Player)
	 */
	@Test
	public void testDraw() {
		...
		p1.getAccount().setBalance(10000);
		card.draw(p1);
		assertThat(p1.getAccount().getBalance()).isEqualTo(10000-1500);
		...
		p1.getAccount().setBalance(10000);
		card.draw(p1);
		assertThat(p1.getAccount().getBalance()).isEqualTo(10000-2500);
	}
}